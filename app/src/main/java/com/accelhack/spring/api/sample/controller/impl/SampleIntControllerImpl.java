package com.accelhack.spring.api.sample.controller.impl;

import com.accelhack.spring.api.sample.model.SampleModel;
import com.accelhack.spring.api.sample.usecase.SampleUsecase;
import com.accelhack.spring.api.shared.controller.impl.InternalController;
import com.accelhack.spring.api.sample.controller.SampleController;
...
public class SampleIntControllerImpl extends InternalController implements SampleController {
  ...
  /**
   * curl -X PUT -H 'Content-Type: application/json' -d '{"operand": {"name": "kengo","birthday":
  ...
  /**
   * curl -X POST -H 'Content-Type: application/json' \ -d '{"operand": {"id":
   * "ee4d8f69-7b37-45b2-ba55-08a23e429ec3", "name": "kengo", "birthday": "1993-02-23T00:00:00Z",
