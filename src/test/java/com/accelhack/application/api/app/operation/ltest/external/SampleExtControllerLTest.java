...
public class SampleExtControllerLTest extends ExtControllerLTest {
  ...
  @DisplayName("取得")
  @DbUnitConfiguration(
      databaseConnection = {DataSourceKeys.YOUR_APPLICATION, DataSourceKeys.API_APPLICATION},
      dataSetLoader = CsvDataSetLoader.class)
  class Get {
    @Test
    @DisplayName("POST: /api/v1/sample/get")
    @DatabaseSetups({
        @DatabaseSetup(value = "/database/testdata/ltest/init/app",
            connection = DataSourceKeys.YOUR_APPLICATION),
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
    ...
    public void get() throws Exception {
      ...
      // result
      performPost("/api/v1/sample/get", request)
          // check status
  ...
  class Search {
    @Test
    @DisplayName("POST: /api/v1/sample/search")
    @DatabaseSetups({
        @DatabaseSetup(value = "/database/testdata/ltest/init/app",
            connection = DataSourceKeys.YOUR_APPLICATION),
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
    ...
    public void search() throws Exception {
      ...
      // result
      performPost("/api/v1/sample/search", request)
          // check status
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.statusCode").value(HttpStatus.OK.value()))
          .andExpect(jsonPath("$.total").value(1))
          ...
          .andExpect(
              jsonPath("$.results[0].result.items[0].birthday").value("2001-09-21T00:00:00Z"))
          ...
          .andExpect(
              jsonPath("$.results[0].result.items[1].birthday").value("1998-02-09T00:00:00Z"))
  ...
  class Add {
    ...
    @DatabaseSetups({
        ...
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
            connection = DataSourceKeys.API_APPLICATION)})
    @ExpectedDatabase(
        value = "/database/testdata/ltest/result/SampleExtControllerImplLTest/create-expected",
    ...
    public void add() throws Exception {
      ...
      // result
      performPost("/api/v1/sample/add", request)
          // check status
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.statusCode").value(HttpStatus.OK.value()))
          .andExpect(jsonPath("$.total").value(1))
  ...
  class Edit {
    ...
    @DatabaseSetups({
        ...
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
            connection = DataSourceKeys.API_APPLICATION)})
    @ExpectedDatabase(
        value = "/database/testdata/ltest/result/SampleExtControllerImplLTest/update-expected",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
    public void edit() throws Exception {
      ...
      // result
      performPost("/api/v1/sample/edit", request)
          // check status
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.statusCode").value(HttpStatus.OK.value()))
          .andExpect(jsonPath("$.total").value(1))
  ...
  class Remove {
    ...
    @DatabaseSetups({
        ...
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
            connection = DataSourceKeys.API_APPLICATION)})
    @ExpectedDatabase(
        value = "/database/testdata/ltest/result/SampleExtControllerImplLTest/delete-expected",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
    public void remove() throws Exception {
      ...
      // result
      performPost("/api/v1/sample/remove", request)
          // check status
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.statusCode").value(HttpStatus.OK.value()))
          .andExpect(jsonPath("$.total").value(1))
