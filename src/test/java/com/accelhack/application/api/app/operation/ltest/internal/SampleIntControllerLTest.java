  ...
  class Add {
    ...
    @DatabaseSetups({
        ...
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
            connection = DataSourceKeys.API_APPLICATION)})
    @ExpectedDatabase(
        value = "/database/testdata/ltest/result/SampleIntControllerImplLTest/create-expected",
  ...
  class Edit {
    ...
    @DatabaseSetups({
        ...
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
            connection = DataSourceKeys.API_APPLICATION)})
    @ExpectedDatabase(
        value = "/database/testdata/ltest/result/SampleIntControllerImplLTest/update-expected",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
  ...
  class Remove {
    ...
    @DatabaseSetups({
        ...
        @DatabaseSetup(value = "/database/testdata/ltest/init/shared",
            connection = DataSourceKeys.API_APPLICATION)})
    @ExpectedDatabase(
        value = "/database/testdata/ltest/result/SampleIntControllerImplLTest/delete-expected",
        assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
