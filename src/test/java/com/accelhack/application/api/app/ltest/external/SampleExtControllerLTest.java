...
public class SampleExtControllerLTest extends ExtControllerLTest {
  ...
  class Add {
    ...
    @ExpectedDatabase(value = "/database/testdata/ltest/result/SampleExtControllerImplLTest/create-expected", assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
  ...
  class Edit {
    ...
    @ExpectedDatabase(value = "/database/testdata/ltest/result/SampleExtControllerImplLTest/update-expected", assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
  ...
  class Remove {
    ...
    @ExpectedDatabase(value = "/database/testdata/ltest/result/SampleExtControllerImplLTest/delete-expected", assertionMode = DatabaseAssertionMode.NON_STRICT_UNORDERED)
